...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="resources/images/si.jpg">
			        <div class="thumb-image"> <img src="resources/images/lak.jpg" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
...
<div class="col-md-7 single-top-in">
				...
				<h3>LAKME</h3>
				<p class="in-para">ICONIC KAJAL  </p>
			    <div class="price_single">
				  <span class="reducedfrom item_price">Rs.800.00</span>
