   ...
   <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
        <ul class="nav navbar-nav nav_1">
            <li><a class="color" href="allCat">Category</a></li>
            
    			<li><a class="color4" href="allUser">User</a></li>
           
            <li ><a class="color6" href="allProd">Products</a></li>
            
            <li ><a class="color6" href="allSupp">Supplier</a></li>
        </ul>
     </div><!-- /.navbar-collapse -->
